...
const IconTextInput = ({ placeholder="Email Address", PostTextIcon = "ArrowRight1", PreTextIcon = "SmsTracking" , errorText, charLimit, showCharLimit, disabled, onChange = () => {}, required, type, className, value }: IconTextInput) => {
